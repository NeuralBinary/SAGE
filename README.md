...
Python 3.11 or newer is required. Download the v0.2.2 release wheel from the
[GitHub release](https://github.com/NeuralBinary/SAGE/releases/tag/v0.2.2), then
...
`RELEASE-v0.2.2.md` and `VERIFICATION.md`.
